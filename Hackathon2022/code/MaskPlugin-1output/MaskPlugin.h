...
public:
    ...
    DimsExprs getOutputDimensions(int32_t outputIndex, const DimsExprs *inputs, int32_t nbInputs, IExprBuilder &exprBuilder) noexcept override
    {
        ...
        case 0:
            ...
            ret.d[2]   = exprBuilder.operation(DimensionOperation::kSUB,
    ...
    bool supportsFormatCombination(int32_t pos, const PluginTensorDesc *inOut, int32_t nbInputs, int32_t nbOutputs) noexcept override
    {
        ...
        {
        case 0:
            res = inOut[pos].type == DataType::kFLOAT && inOut[pos].dims.nbDims == 3;
            break;
        case 1:
            res = inOut[pos].type == DataType::kINT32 && inOut[pos].dims.nbDims == 1;
            break;
        case 2:
...
#if DEBUG
        printf("pos=%d,res=%d,[%d,%d,%d]\n", pos, int(res), int(inOut[0].type), int(inOut[1].type), int(inOut[2].type));
#endif
        return res;
    }
