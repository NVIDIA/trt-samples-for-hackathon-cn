...
graph = gs.import_onnx(onnx.load(onnx_file + "_01.onnx"))  # load the graph from ONNX file
...
graph.cleanup().toposort()
onnx.save(gs.export_onnx(graph), onnx_file + "_02.onnx")
...
graph.cleanup().toposort()
onnx.save(gs.export_onnx(graph), onnx_file + "_03.onnx")
