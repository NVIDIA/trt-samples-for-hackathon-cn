...
class BuilderFlag:
    ...
    FP4: typing.ClassVar[BuilderFlag]  # value = <BuilderFlag.FP4: 24>
...
class LayerType:
    ...
    DYNAMIC_QUANTIZE: typing.ClassVar[LayerType]  # value = <LayerType.DYNAMIC_QUANTIZE: 47>
