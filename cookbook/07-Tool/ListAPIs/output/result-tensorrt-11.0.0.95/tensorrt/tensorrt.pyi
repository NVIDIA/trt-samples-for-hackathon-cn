...
class BuilderFlag:
    ...
    """
    BF16: typing.ClassVar[BuilderFlag]  # value = <BuilderFlag.BF16: 16>
    ...
    FP4: typing.ClassVar[BuilderFlag]  # value = <BuilderFlag.FP4: 25>
    FP8: typing.ClassVar[BuilderFlag]  # value = <BuilderFlag.FP8: 14>
    GPU_FALLBACK: typing.ClassVar[BuilderFlag]  # value = <BuilderFlag.GPU_FALLBACK: 3>
    INT4: typing.ClassVar[BuilderFlag]  # value = <BuilderFlag.INT4: 21>
    ...
    __members__: typing.ClassVar[dict[str, BuilderFlag]]  # value = {'FP16': <BuilderFlag.FP16: 0>, 'BF16': <BuilderFlag.BF16: 16>, 'INT8': <BuilderFlag.INT8: 1>, 'DEBUG': <BuilderFlag.DEBUG: 2>, 'GPU_FALLBACK': <BuilderFlag.GPU_FALLBACK: 3>, 'REFIT': <BuilderFlag.REFIT: 4>, 'DISABLE_TIMING_CACHE': <BuilderFlag.DISABLE_TIMING_CACHE: 5>, 'EDITABLE_TIMING_CACHE': <BuilderFlag.EDITABLE_TIMING_CACHE: 26>, 'TF32': <BuilderFlag.TF32: 6>, 'SPARSE_WEIGHTS': <BuilderFlag.SPARSE_WEIGHTS: 7>, 'SAFETY_SCOPE': <BuilderFlag.SAFETY_SCOPE: 8>, 'OBEY_PRECISION_CONSTRAINTS': <BuilderFlag.OBEY_PRECISION_CONSTRAINTS: 9>, 'PREFER_PRECISION_CONSTRAINTS': <BuilderFlag.PREFER_PRECISION_CONSTRAINTS: 10>, 'DIRECT_IO': <BuilderFlag.DIRECT_IO: 11>, 'VERSION_COMPATIBLE': <BuilderFlag.VERSION_COMPATIBLE: 12>, 'EXCLUDE_LEAN_RUNTIME': <BuilderFlag.EXCLUDE_LEAN_RUNTIME: 13>, 'FP8': <BuilderFlag.FP8: 14>, 'ERROR_ON_TIMING_CACHE_MISS': <BuilderFlag.ERROR_ON_TIMING_CACHE_MISS: 15>, 'DISABLE_COMPILATION_CACHE': <BuilderFlag.DISABLE_COMPILATION_CACHE: 17>, 'STRIP_PLAN': <BuilderFlag.STRIP_PLAN: 18>, 'REFIT_IDENTICAL': <BuilderFlag.REFIT_IDENTICAL: 19>, 'WEIGHT_STREAMING': <BuilderFlag.WEIGHT_STREAMING: 20>, 'INT4': <BuilderFlag.INT4: 21>, 'REFIT_INDIVIDUAL': <BuilderFlag.REFIT_INDIVIDUAL: 22>, 'STRICT_NANS': <BuilderFlag.STRICT_NANS: 23>, 'MONITOR_MEMORY': <BuilderFlag.MONITOR_MEMORY: 24>, 'FP4': <BuilderFlag.FP4: 25>, 'DISTRIBUTIVE_INDEPENDENCE': <BuilderFlag.DISTRIBUTIVE_INDEPENDENCE: 27>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __ge__(self, other: typing.Any) -> bool:
        ...
...
class CausalMaskKind:
    ...
    __members__: typing.ClassVar[dict[str, CausalMaskKind]]  # value = {'NONE': <CausalMaskKind.NONE: 0>, 'UPPER_LEFT': <CausalMaskKind.UPPER_LEFT: 1>, 'LOWER_RIGHT': <CausalMaskKind.LOWER_RIGHT: 2>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class CollectiveOperation:
    ...
    __members__: typing.ClassVar[dict[str, CollectiveOperation]]  # value = {'ALL_REDUCE': <CollectiveOperation.ALL_REDUCE: 0>, 'ALL_GATHER': <CollectiveOperation.ALL_GATHER: 1>, 'BROADCAST': <CollectiveOperation.BROADCAST: 2>, 'REDUCE': <CollectiveOperation.REDUCE: 3>, 'REDUCE_SCATTER': <CollectiveOperation.REDUCE_SCATTER: 4>, 'ALL_TO_ALL': <CollectiveOperation.ALL_TO_ALL: 5>, 'GATHER': <CollectiveOperation.GATHER: 6>, 'SCATTER': <CollectiveOperation.SCATTER: 7>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class IBuilderConfig:
    ...
    def max_aux_streams(self, arg1: typing.SupportsInt) -> bool:
        ...
    @property
...
class INetworkDefinition:
    ...
    def add_attention(self, query: ITensor, key: ITensor, value: ITensor, norm_op: AttentionNormalizationOp, causal: bool) -> IAttention:
        ...
        """
    def add_attention_v2(self, query: ITensor, key: ITensor, value: ITensor, norm_op: AttentionNormalizationOp, causal_kind: CausalMaskKind) -> IAttention:
        """
...
class NetworkDefinitionCreationFlag:
    ...
    """
    PREFER_AOT_PYTHON_PLUGINS: typing.ClassVar[NetworkDefinitionCreationFlag]  # value = <NetworkDefinitionCreationFlag.PREFER_AOT_PYTHON_PLUGINS: 2>
    PREFER_JIT_PYTHON_PLUGINS: typing.ClassVar[NetworkDefinitionCreationFlag]  # value = <NetworkDefinitionCreationFlag.PREFER_JIT_PYTHON_PLUGINS: 1>
    STRONGLY_TYPED: typing.ClassVar[NetworkDefinitionCreationFlag]  # value = <NetworkDefinitionCreationFlag.STRONGLY_TYPED: 0>
    __members__: typing.ClassVar[dict[str, NetworkDefinitionCreationFlag]]  # value = {'STRONGLY_TYPED': <NetworkDefinitionCreationFlag.STRONGLY_TYPED: 0>, 'PREFER_AOT_PYTHON_PLUGINS': <NetworkDefinitionCreationFlag.PREFER_AOT_PYTHON_PLUGINS: 2>, 'PREFER_JIT_PYTHON_PLUGINS': <NetworkDefinitionCreationFlag.PREFER_JIT_PYTHON_PLUGINS: 1>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __ge__(self, other: typing.Any) -> bool:
        ...
...
class PreviewFeature:
    ...
    RUNTIME_ACTIVATION_RESIZE_10_10: typing.ClassVar[PreviewFeature]  # value = <PreviewFeature.RUNTIME_ACTIVATION_RESIZE_10_10: 1>
    __members__: typing.ClassVar[dict[str, PreviewFeature]]  # value = {'ALIASED_PLUGIN_IO_10_03': <PreviewFeature.ALIASED_PLUGIN_IO_10_03: 0>, 'RUNTIME_ACTIVATION_RESIZE_10_10': <PreviewFeature.RUNTIME_ACTIVATION_RESIZE_10_10: 1>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
