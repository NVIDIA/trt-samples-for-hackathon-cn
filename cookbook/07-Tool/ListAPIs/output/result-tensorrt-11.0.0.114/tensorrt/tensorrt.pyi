...
class AttentionIOForm:
    ...
    __members__: typing.ClassVar[dict[str, AttentionIOForm]]  # value = {'PADDED_BHND': <AttentionIOForm.PADDED_BHND: 0>, 'PACKED_NHD': <AttentionIOForm.PACKED_NHD: 1>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class TacticSource:
    ...
    __members__: typing.ClassVar[dict[str, TacticSource]]  # value = {'EDGE_MASK_CONVOLUTIONS': <TacticSource.EDGE_MASK_CONVOLUTIONS: 0>, 'JIT_CONVOLUTIONS': <TacticSource.JIT_CONVOLUTIONS: 1>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __ge__(self, other: typing.Any) -> bool:
        ...
