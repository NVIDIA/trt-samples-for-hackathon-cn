...
def print_engine_information(args, p: Pointer):
    # ================================================================
...
def print_io(args, engine_bytes):
    ...
    try:
        ...
        print("Failed loading engine, `print_io()` is only supported when TRT version of engine and runtime is the same.")
        return
...
if __name__ == "__main__":
    ...
    print_engine_information(args, Pointer(engine_bytes))

    print_io(args, engine_bytes)
