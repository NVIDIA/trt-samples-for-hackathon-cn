...
polygraphy template trt-config model-trained.onnx \
    --output modify_config.py

#03-Create a script to modify ONNX file
polygraphy template onnx-gs model-trained.onnx \
