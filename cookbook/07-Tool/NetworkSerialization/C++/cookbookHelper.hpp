...
template<typename T>
void printArrayInformation(const T *pArray, Dims64 dim, std::string name = std::string(""), bool bPrintArray = false, int n = 10)
{
...
template void printArrayInformation(const float *, Dims64, std::string, bool, int);
template void printArrayInformation(const half *, Dims64, std::string, bool, int);
template void printArrayInformation(const int *, Dims64, std::string, bool, int);
template void printArrayInformation(const bool *, Dims64, std::string, bool, int);
