...
int main()
{
    ...
    ITensor *inputTensor = network->addInput("inputT0", DataType::kFLOAT, Dims64 {4, {-1, 1, nHeight, nWidth}});
    profile->setDimensions(inputTensor->getName(), OptProfileSelector::kMIN, Dims64 {4, {1, 1, nHeight, nWidth}});
    profile->setDimensions(inputTensor->getName(), OptProfileSelector::kOPT, Dims64 {4, {4, 1, nHeight, nWidth}});
    profile->setDimensions(inputTensor->getName(), OptProfileSelector::kMAX, Dims64 {4, {8, 1, nHeight, nWidth}});
