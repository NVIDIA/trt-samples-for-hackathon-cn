...
nBuilderOptimizationLevel = 5
planFile = "model-%d.plan" % nBuilderOptimizationLevel
...
config.builder_optimization_level = nBuilderOptimizationLevel

inputTensor = network.add_input("inputT0", trt.float32, [-1, 1024, 64])  # I write a "complex" network to see the performance differences
