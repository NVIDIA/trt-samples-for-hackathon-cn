...
from tensorrt_cookbook import (TRTWrapperV1, case_mark, ceil_divide,
                               check_array, round_up)
...
def case_(shape, data_type, format):
    ...
    match (data_type, format):
        case trt.DataType.FLOAT, trt.TensorFormat.LINEAR:
            check_array(oo, ii)
            check_array(ii, oo)

        case trt.DataType.HALF, trt.TensorFormat.CHW2:
        ...
        case trt.DataType.HALF, trt.TensorFormat.HWC8:
        ...
        case trt.DataType.HALF, trt.TensorFormat.CHW4:
        ...
        case trt.DataType.HALF, trt.TensorFormat.CHW16:
        ...
        case trt.DataType.FLOAT, trt.TensorFormat.CHW32:
        ...
        case trt.DataType.HALF, trt.TensorFormat.DHWC8:
            if shape[1] % 8 == 0:  # no pad
        ...
        case trt.DataType.HALF, trt.TensorFormat.CDHW32:
            if shape[1] % 32 == 0:  #  no pad
        ...
        case trt.DataType.FLOAT, trt.TensorFormat.HWC:
        ...
        case trt.DataType.HALF, trt.TensorFormat.HWC16:
            if shape[1] % 16 == 0:  # no pad
                check_array(oo, ii.reshape(shape[0], shape[1] // 16, 16, shape[2], shape[3]).transpose(0, 1, 3, 4, 2).reshape(shape))
        ...
        case trt.DataType.FLOAT, trt.TensorFormat.DHWC:
