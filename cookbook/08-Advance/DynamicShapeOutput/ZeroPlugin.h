...
namespace
{
static const char *PLUGIN_NAME {"Zero"};
static const char *PLUGIN_VERSION {"1"};
} // namespace

namespace nvinfer1
{
class ZeroPlugin : public IPluginV2DynamicExt
{
private:
...
public:
    ZeroPlugin() = delete;
    ZeroPlugin(const std::string &name);
    ZeroPlugin(const std::string &name, const void *buffer, size_t length);
    ~ZeroPlugin();
