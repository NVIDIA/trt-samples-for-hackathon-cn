...
weight = np.ascontiguousarray(np.power(10, range(4, -5, -1), dtype=np.float32))
...
deconvolutionLayer = network.add_deconvolution_nd(dequantizeLayer0.get_output(0), nCOut, (nKernelHeight, nKernelWidth), trt.Weights())  # set weight as empty in the constructor
