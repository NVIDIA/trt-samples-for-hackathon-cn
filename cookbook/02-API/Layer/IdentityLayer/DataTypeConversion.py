...
config.set_flag(trt.BuilderFlag.FP16)  # FP16 and INT8 need corresponding mode
...
convertToInt8Layer.get_output(0).set_dynamic_range(0, 127)  # INT8 mode need dynamic range or calibration
#------------------------------------------------------------------------------- Network
