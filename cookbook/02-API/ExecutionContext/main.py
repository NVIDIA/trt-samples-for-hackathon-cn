...
from tensorrt_cookbook import (TRTWrapperShapeInput, check_api_coverage, print_enumerated_members)
...
# Possible values of a tensor's IO mode and location
print_enumerated_members(trt.TensorIOMode)
print_enumerated_members(trt.TensorLocation)
