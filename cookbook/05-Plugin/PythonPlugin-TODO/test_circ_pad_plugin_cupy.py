...
# plugin_creator = plg_registry.get_plugin_creator("LayerNorm", "1")
# print(plugin_creator.name)
# field_collection = trt.PluginFieldCollection([
#     trt.PluginField("epsilon", np.array([0.001]), type=trt.PluginFieldType.FLOAT32),
#     trt.PluginField("axis", np.array([1]), type=trt.PluginFieldType.INT32)
# ])
# plugin = plugin_creator.create_plugin(name="LayerNorm", field_collection=field_collection)

# print("### - LayerNorm - ###")
# print(plugin.tensorrt_version)
# print(plugin.num_outputs)
# print(plugin.serialization_size)
# print(plugin.plugin_namespace)

# print(trt.IPluginV2DynamicExt_reserved)


# print("### - CircPadPlugin - ###")
# obj = CircPadPlugin()
# print(obj.num_outputs)
# print(f"Created obj {id(obj)}")
# del obj
# print(obj.tensorrt_version)
# print(obj.num_outputs)
# print(obj.serialization_size)
# print(obj.get_plugin_version())
# print(obj.plugin_namespace)
# obj.plugin_namespace = "nfohu34h59873hfui4"
# print(obj.namespace)


# print(obj.plugin_type)
# print(obj.plugin_version)
# print(obj.plugin_namespace)
