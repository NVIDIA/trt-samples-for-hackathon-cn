...
static char const *PLUGIN_VERSION_V2 {"2"};
} // namespace
...
class AddScalarPluginV2 : public AddScalarPlugin
{
public:
    AddScalarPluginV2() = delete;
    AddScalarPluginV2(float const scalar);
    AddScalarPluginV2(AddScalarPluginV2 const &p) = default;
    IPluginV3  *clone() noexcept override;
    char const *getPluginVersion() const noexcept override;
    int32_t     enqueue(PluginTensorDesc const *inputDesc, PluginTensorDesc const *outputDesc, void const *const *inputs, void *const *outputs, void *workspace, cudaStream_t stream) noexcept override;
};

class AddScalarPluginCreatorV2 : public AddScalarPluginCreator
{
public:
    char const *getPluginVersion() const noexcept override;
    IPluginV3  *createPlugin(char const *name, PluginFieldCollection const *fc, TensorRTPhase phase) noexcept override;
