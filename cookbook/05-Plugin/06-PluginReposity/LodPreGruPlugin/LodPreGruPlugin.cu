...
__global__ void lodPreGruKernel(    int nGroup, int nWidth0, int nWidth2, int nWidth4, int nWidth6, 
                                    ...
                                    float* out7, float* out8, float* out9, float* out10,float* out11,float* out12,float* out13,
...
__global__ void lodPreGruKernelHalf(   int nGroup, int nWidth0, int nWidth2, int nWidth4, int nWidth6, 
                                    ...
                                    __half* out7, __half* out8, __half* out9, __half* out10, __half* out11, __half* out12, __half* out13,
                                    int*    out14,int*    out15,int*    out16,int*    out17)
{
