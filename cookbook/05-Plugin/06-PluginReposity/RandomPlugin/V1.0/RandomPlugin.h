...
public:
    ...
    RandomPlugin(const void *buffer, size_t length) {memcpy(&m, buffer, sizeof(m));}    
    IPluginV2Ext* clone() const override {return new RandomPlugin(&m, sizeof(m));}
    ...
    const char* getPluginType() const override { return "RandomPlugin";}
...
public:        
    ...
    const char* getPluginName() const override {return "RandomPlugin";}
    const char* getPluginVersion() const override {return "0";}
    void setPluginNamespace(const char* szNamespace) override {}
    const char* getPluginNamespace() const override {return "";}
    const PluginFieldCollection* getFieldNames() override {return nullptr;}
    IPluginV2* deserializePlugin(const char* name, const void* serialData, size_t serialLength) override {return new RandomPlugin(serialData, serialLength);}
};
