...
public:
    ...
    bool supportsFormatCombination(int32_t pos, const PluginTensorDesc* inOut, int32_t nbInputs, int32_t nbOutputs) noexcept override
    {
        ...
        {
        case 0:
            res = (inOut[0].type == DataType::kFLOAT || inOut[0].type == DataType::kHALF) && inOut[0].dims.nbDims == 3; break;
        case 1:
            res = inOut[1].type == DataType::kINT32 && inOut[1].dims.nbDims == 1; break;
        case 2:
        case 3:
            res = (inOut[pos].type == DataType::kFLOAT || inOut[pos].type == DataType::kHALF) && inOut[pos].dims.nbDims == 4; break;
        case 4:
            res = (inOut[4].type == DataType::kFLOAT || inOut[4].type == DataType::kHALF) && inOut[4].dims.nbDims == 3; break;
        default:// should NOT be here
            break;
        }
#if DEBUG_ENABLE        
