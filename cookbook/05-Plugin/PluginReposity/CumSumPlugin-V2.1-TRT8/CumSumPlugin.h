...
namespace
{
static const char *PLUGIN_NAME {"CumSum"};
...
public:
    CumSumPlugin() = delete;
    CumSumPlugin(const std::string &name, int nAxis, int bInclusive);
    CumSumPlugin(const std::string &name, const void *buffer, size_t length);
    ~CumSumPlugin();
