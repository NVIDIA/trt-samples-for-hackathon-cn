...
__global__ void topKAverageKernelV3(const float *in_data, const int32_t *row_lod,const int32_t *col_lod, const int32_t *k_array,
                                    int32_t k_num,int32_t max_row, int32_t max_col, int32_t *pos_data, float *out_data)
{
...
__global__ void topKAverageKernelHalfV3(const __half *in_data, const int32_t *row_lod,const int32_t *col_lod, const int32_t *k_array,
                                        int32_t k_num,int32_t max_row, int32_t max_col, int32_t *pos_data, __half *out_data)
{
    const int32_t max_k = k_array[k_num - 1];
	const int32_t row_pos = blockDim.y * blockIdx.x + threadIdx.y;
    if (row_pos >= row_lod[blockIdx.z])
