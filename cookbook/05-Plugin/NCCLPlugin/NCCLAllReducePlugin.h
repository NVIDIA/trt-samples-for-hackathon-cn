...
namespace
{
static char const *PLUGIN_NAME {"NCCLAllReduce"};
...
class NCCLAllReducePlugin : public IPluginV3, public IPluginV3OneCore, public IPluginV3OneBuild, public IPluginV3OneRuntime
{
private:
    int32_t                  mRank {0};
    int32_t                  mWorldSize {1};
    ncclUniqueId             mUniqueId {};
    bool                     mCommInited {false};
    ncclComm_t               mComm {};
    std::vector<PluginField> mDataToSerialize;
    PluginFieldCollection    mFCToSerialize;

public:
    NCCLAllReducePlugin() = delete;
    NCCLAllReducePlugin(int32_t rank, int32_t worldSize, ncclUniqueId const &uniqueId);
    NCCLAllReducePlugin(NCCLAllReducePlugin const &p) = default;
    ~NCCLAllReducePlugin() override;
...
class NCCLAllReducePluginCreator : public IPluginCreatorV3One
{
private:
