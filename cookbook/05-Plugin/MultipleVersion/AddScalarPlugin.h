...
public:
    ...
    AddScalarPluginV2(const std::string &name, float scalar);
    AddScalarPluginV2(const std::string &name, const void *buffer, size_t length);
    ~AddScalarPluginV2();
