...
namespace
{
static char const *PLUGIN_NAME {"PassHostData"};
...
namespace nvinfer1
{
class PassHostDataPlugin : public IPluginV3, public IPluginV3OneCore, public IPluginV3OneBuild, public IPluginV3OneRuntime
{
private:
    float                    mScalar {0.0f};
...
public:
    PassHostDataPlugin() = delete;
    PassHostDataPlugin(float const scalar);
    PassHostDataPlugin(PassHostDataPlugin const &p) = default;
...
class PassHostDataPluginCreator : public IPluginCreatorV3One
{
private:
