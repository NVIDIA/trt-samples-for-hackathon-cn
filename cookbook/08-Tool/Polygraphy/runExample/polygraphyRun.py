#!/usr/bin/env python3
# Template auto-generated by polygraphy [v0.38.0] on 08/17/22 at 06:44:45
# Generation Command: /opt/conda/bin/polygraphy run model.onnx --onnxrt --trt --pool-limit workspace:1000000000 --save-engine=model-FP32.plan --save-tactics=./model.tactic --save-inputs=./model-input.log --save-outputs=./model-output.log --atol 1e-3 --rtol 1e-3 --silent --gen-script=./polygraphyRun.py --trt-min-shapes tensor-0:[1,1,28,28] --trt-opt-shapes tensor-0:[4,1,28,28] --trt-max-shapes tensor-0:[16,1,28,28] --input-shapes tensor-0:[4,1,28,28]
...
create_trt_config = CreateTrtConfig(profiles=profiles, algorithm_selector=TacticRecorder(record='./model.tactic'), memory_pool_limits={trt.MemoryPoolType.WORKSPACE: 1000000000})
