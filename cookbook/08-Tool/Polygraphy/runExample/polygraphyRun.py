#!/usr/bin/env python3
# Template auto-generated by polygraphy [v0.33.0] on 03/19/22 at 12:11:50
# Generation Command: /usr/local/bin/polygraphy run model.onnx --onnxrt --trt --workspace 1000000000 --save-engine=model-FP32.plan --atol 1e-3 --rtol 1e-3 --verbose --gen-script=./polygraphyRun.py --trt-min-shapes x:0:[1,1,28,28] --trt-opt-shapes x:0:[4,1,28,28] --trt-max-shapes x:0:[16,1,28,28] --input-shapes x:0:[4,1,28,28]
...
# Data Loader
data_loader = DataLoader(input_metadata=TensorMetadata().add('x:0', None, (4, 1, 28, 28)))
...
profiles = [
    Profile().add('x:0', min=[1, 1, 28, 28], opt=[4, 1, 28, 28], max=[16, 1, 28, 28])
]
