...
namespace
{
inline constexpr char PLUGIN_NAME[] {"Nothing"};
...
namespace nvinfer1
{
class NothingPlugin : public IPluginV3, public IPluginV3OneCore, public IPluginV3OneBuild, public IPluginV3OneRuntime
{
private:
    float                    mSize {0.0f};
...
public:
    NothingPlugin() = delete;
    NothingPlugin(float const scalar);
    NothingPlugin(NothingPlugin const &p) = default;
...
class NothingPluginCreator : public IPluginCreatorV3One
{
private:
