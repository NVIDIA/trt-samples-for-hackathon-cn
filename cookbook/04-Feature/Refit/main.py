...
from tensorrt_cookbook import case_mark, cookbook_path, datatype_cast, parse_onnx, TRTWrapperV1, print_enumerated_members
...
def case_set_weights():
    ...
    print_enumerated_members(trt.WeightsRole)
