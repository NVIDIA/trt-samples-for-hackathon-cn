...
node0 = gs.Node("Slice", "mySlice", inputs=inputList, outputs=[tensor1])  # 定义节点，使用张量作为输入和输出

graph = gs.Graph(nodes=[node0], inputs=[tensor0], outputs=[tensor1])  # 定义计算图，要求给出所有节点和输入输出张量
