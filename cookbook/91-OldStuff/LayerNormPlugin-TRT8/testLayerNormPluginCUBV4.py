...
if __name__ == "__main__":
    ...
    case_simple([16, 64, 32], False)
    case_simple([16, 64, 32], True)
    case_simple([16, 64, 256], False)
    case_simple([16, 64, 256], True)
    case_simple([16, 64, 1024], False)
    case_simple([16, 64, 1024], True)
    case_simple([16, 64, 1600], False)
    case_simple([16, 64, 1600], True)
