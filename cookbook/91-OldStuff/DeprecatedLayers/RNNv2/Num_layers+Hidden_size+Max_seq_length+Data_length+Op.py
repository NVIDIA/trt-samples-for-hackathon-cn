...
def case_simple():
    ...
    layer.op = trt.RNNOperation.RELU  # Reset the RNN operation type
    ...
    # Read-only attributes derived from the constructor arguments
    print(f"num_layers={layer.num_layers}")
    print(f"hidden_size={layer.hidden_size}")
    print(f"max_seq_length={layer.max_seq_length}")
    print(f"data_length={layer.data_length}")
...
if __name__ == "__main__":
    # A case of reading RNNv2 attributes and resetting the operation type
    case_simple()
