...
public:
  ...
  bool supportsFormatCombination(int pos,
    ...
    printf("[supportsFormatCombination]:[%d,%d],[%d,%d]\n", (int)inOut[0].type,
           (int)inOut[1].type, (int)inOut[0].format, (int)inOut[1].format);
    bool res;
    switch (pos) {
    case 0:
      res = ((inOut[0].type == nvinfer1::DataType::kFLOAT ||
    ...
    case 1:
      res =
          inOut[0].format == inOut[1].format && inOut[0].type == inOut[1].type;
      printf("pos = 1, res = %d\n", (int)res);
      return res;
    }
    return false;
