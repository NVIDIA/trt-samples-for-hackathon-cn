    ...
    def __init__(self,
        ...
        self.blocks1 = nn.ModuleList([
            CBlock(dim=embed_dim[0],
                   ...
                   drop_path=dpr[i],
                   norm_layer=norm_layer) for i in range(layers[0])
        ])
        self.norm1 = norm_layer(embed_dim[0])
        self.blocks2 = nn.ModuleList([
            CBlock(dim=embed_dim[1],
        ...
        if self.windows:
            ...
            self.blocks3 = nn.ModuleList([
                SABlock(dim=embed_dim[2],
                        ...
                        attn_drop=attn_drop_rate,
                        drop_path=dpr[i + layers[0] + layers[1]],
                        norm_layer=norm_layer) for i in range(layers[2])
            ])
        self.norm3 = norm_layer(embed_dim[2])
        self.blocks4 = nn.ModuleList([
            SABlock(dim=embed_dim[3],
                    ...
                    norm_layer=norm_layer) for i in range(layers[3])
        ])
